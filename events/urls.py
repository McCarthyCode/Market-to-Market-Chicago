...
urlpatterns = [
    ...
    re_path(r'^(?P<category>(nightlife|restaurants|arts-and-entertainment|health-and-fitness|sports|non-profit))/(?P<location_name>[\da-z]+(-[\da-z]+)*)/(?P<event_name>[\da-z]+(-[\da-z]+)*)/(?P<event_id>[1-9]\d*)/$', views.event, name='event'),
]
