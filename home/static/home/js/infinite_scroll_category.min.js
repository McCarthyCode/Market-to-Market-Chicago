...
$(document).ready(function(){$.fn.isInViewport=function(){if(!$(this).is(":visible"))return!1;var a=$(this).offset().top,b=a+$(this).outerHeight(),c=$(window).scrollTop(),d=c+$(window).height();return b>=c&&a<=d};var a=$("#content"),b=$("#categoryFeed"),c=b.find("> li:last-of-type"),e=!1,d=!1,f=2;a.on("scroll",function(){c=b.find("> li:last-of-type");d||e||!c.isInViewport()||(d=!0,$.ajax("/"+$('input[name="category-slug"]').val()+"/"+f+"/",{success:function(a){b.append(a);f++;d=!1},statusCode:{204:function(){b.append('<li class="empty-card">No more items to display.</li>');
e=!0;d=!1}}}))})});
