...
$("#neighborhoodAutocompleteLocation li").length})});d.keydown(function(a){switch(a.keyCode){case 13:a.preventDefault();a=$("#neighborhoodAutocompleteLocation li.active");1===$("#neighborhoodAutocompleteLocation li").length&&(a=$("#neighborhoodAutocompleteLocation li:first-child"));e.val(a.data("id"));d.val(a.text());$("#neighborhoodAutocompleteLocation ul").remove();break;case 38:b=-1===b?c-1:(b+1)%c;$("#neighborhoodAutocompleteLocation li").removeClass("active");$("#neighborhoodAutocompleteLocation li:nth-child("+
(b+1)+")").addClass("active");break;case 40:b=-1===b?0:(b+c-1)%c,$("#neighborhoodAutocompleteLocation li").removeClass("active"),$("#neighborhoodAutocompleteLocation li:nth-child("+(b+1)+")").addClass("active")}});f.on("click","ul li",function(){e.val($(this).data("id"));d.val($(this).text());$("#neighborhoodAutocompleteLocation ul").fadeOut(500,function(){$(this).remove()})});d.focusout(function(){$("#neighborhoodAutocompleteLocation ul").fadeOut(500,function(){$(this).remove()})})});
