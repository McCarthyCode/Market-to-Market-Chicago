...
1===$("#neighborhoodAutocomplete li").length&&(a=$("#neighborhoodAutocomplete li:first-child"));e.val(a.data("id"));c.val(a.text());$("#neighborhoodAutocomplete ul").remove();break;case 38:b=-1===b?d-1:(b-1+d)%d;$("#neighborhoodAutocomplete li").removeClass("active");$("#neighborhoodAutocomplete li:nth-child("+(b+1)+")").addClass("active");break;case 40:b=-1===b?0:(b+1)%d,$("#neighborhoodAutocomplete li").removeClass("active"),$("#neighborhoodAutocomplete li:nth-child("+(b+1)+")").addClass("active")}});
