...
$jscomp.defineProperty(e,d,{configurable:!0,writable:!0,value:c})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$(function(){$("#content h2").click(function(){var a=$(this);a.siblings(":not(:first-child)").slideToggle(500,function(){a.find("i").toggleClass("fa-chevron-up").toggleClass("fa-chevron-down")})})});
