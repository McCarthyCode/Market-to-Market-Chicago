...
$(function(){var b=-1,d=0,l=$("#authorAutocomplete"),e=$("#id_author"),h=$("#id_author_id");e.on("input",function(a){$("#authorAutocomplete ul").remove();h.val(0);a=$(this).val();""!==a&&$.get("/authors/autocomplete",{q:a},function(a){l.append(a);b=-1;d=$("#authorAutocomplete li").length})});e.keydown(function(a){switch(a.keyCode){case 13:a.preventDefault();a=$("#authorAutocomplete li.active");1===$("#authorAutocomplete li").length&&(a=$("#authorAutocomplete li:first-child"));h.val(a.data("id"));
